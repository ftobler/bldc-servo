...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_11|NSLEEP_Pin
  ...
  /*Configure GPIO pins : PB2 PB10 PB11 NSLEEP_Pin
                           LED3_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_11|NSLEEP_Pin
                          |LED3_Pin;
